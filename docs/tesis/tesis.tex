...
La Figura~\ref{fig:indicadores-social} reproduce la tabla de indicadores de la dimensi\'on social del modelo CORE que sirvi\'o de referencia para el an\'alisis de viabilidad del Cap\'itulo~\ref{ch:viabilidad}.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.55\textwidth, height=0.72\textheight, keepaspectratio]{img_07.png}
